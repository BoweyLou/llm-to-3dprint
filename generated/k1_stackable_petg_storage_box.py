"""Generate a large stackable PETG storage box for the Creality K1.
...
PART_NAME = "k1_stackable_petg_storage_box"
...
# Main envelope. The K1 is 220 x 220 x 250 mm; these dimensions leave margin
# for slicer tolerances, first-layer brim decisions, and tall PETG behavior.
TOP_OUTER = 216.0
...
# Functional features.
HAND_SLOT_LENGTH = 72.0
HAND_SLOT_HEIGHT = 24.0
HAND_SLOT_CENTER_Z = 156.0
HAND_PAD_LENGTH = 100.0
HAND_PAD_HEIGHT = 48.0
...
VISIBILITY_HOLE_WIDTH = 22.0
VISIBILITY_HOLE_HEIGHT = 28.0
VISIBILITY_HOLE_CUT_DEPTH = TOP_OUTER + 18.0
FRONT_BACK_HOLE_XS = (-78.0, -39.0, 0.0, 39.0, 78.0)
FRONT_BACK_HOLE_ZS = (42.0, 78.0, 126.0, 162.0, 198.0)
SIDE_HOLE_YS = (-78.0, -39.0, 0.0, 39.0, 78.0)
SIDE_HOLE_ZS = (42.0, 82.0, 122.0, 194.0)

LABEL_KEEP_OUT_X = LABEL_WIDTH / 2.0 + 15.0
LABEL_KEEP_OUT_Z_MIN = LABEL_CENTER_Z - (LABEL_HEIGHT / 2.0) - 15.0
LABEL_KEEP_OUT_Z_MAX = LABEL_CENTER_Z + (LABEL_HEIGHT / 2.0) + 15.0
HAND_KEEP_OUT_Y = HAND_PAD_LENGTH / 2.0 + 13.0
HAND_KEEP_OUT_Z_MIN = HAND_SLOT_CENTER_Z - (HAND_PAD_HEIGHT / 2.0) - 10.0
HAND_KEEP_OUT_Z_MAX = HAND_SLOT_CENTER_Z + (HAND_PAD_HEIGHT / 2.0) + 10.0
...
def export_all() -> dict:
    ...
    manifest = {
        ...
        "features": {
            ...
            "visibility_hole_shape": "support-friendly diamonds",
        ...
        "print_notes": [
            ...
            "Diamond visibility holes are kept out of the label plaque, hand pads, rim, and base.",
            ...
            "Print the stack-interface coupon first if you want to check stack clearance before the full-height job.",
        ],
    }
